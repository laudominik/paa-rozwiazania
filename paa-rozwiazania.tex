...
(1969) Edmondsa-Karpa $O(nm^2)$ \\
(1970) Dinica $O(n^2m)$ \\
(1974) Karzanova $O(n^3)$\\
(1977) Cherkaskyego   $O(n^2 \sqrt(m))$ \\
(1978) Galila $O(n^{5/3}m^{2/3})$\\
(1978) Shiloacha$O(nmlog^2n)$ \\
(1980) Sleatora-Tarjana $O(nmlogn)$\\
(1986) Goldberga-Tarjana $O(nmlog(\frac{n^2}{m}))$\\
(2013) Orlina $O(nm)$\\
